...
variable "template_base_url" {
  ...
  default = "https://github.com/edhaszard/AZArcJumpstart/tree/main/azure_jumpstart_arcbox/artifacts/"
}
...
resource "azurerm_virtual_machine_extension" "custom_script" {
  ...
  settings = <<SETTINGS
    {
      "fileUris": [
          "https://github.com/edhaszard/AZArcJumpstart/tree/main/azure_jumpstart_arcbox/artifacts/Bootstrap.ps1"
      ],
